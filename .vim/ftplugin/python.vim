""" This governs how vim handles .py or Python files
...
set textwidth=80                " 80 column line width
set wrap                        " wrap text
set expandtab                   " not sure 
...
" --pylint--
" works in conjunction with 'pylint.vim' in ~/.vim/compiler/
...
" Set Pylint as linter. various linter preferences
