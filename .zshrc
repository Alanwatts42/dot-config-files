...
# syntax highlighting - defer means to load this plugin after all others
zplug "zdharma/fast-syntax-highlighting", defer:2

# command auto-suggestion based on history
zplug "zsh-users/zsh-autosuggestions"

# theme - Format: `zplug "git/repo", as:theme`
zplug "agkozak/agkozak-zsh-prompt", as:theme

# <---- zplug plugins go above
