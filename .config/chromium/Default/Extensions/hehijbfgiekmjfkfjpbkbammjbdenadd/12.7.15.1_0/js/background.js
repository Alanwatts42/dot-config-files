...
*/
    ...
    onDailyPing: function() {
        ...
        if (key) {
            ...
            img.src = 'https://www.ietab.net/logger/pingl?key=' + key + '&ext=' + id + '&hv=' + helperVersion + '&rt=0';
        }
            ...
            chrome.management.getSelf(function(info) {
                if(info.installType == 'admin') {
                    ...
                    if (r == 1) {
                        ...
                        if ( (info.id=='knnoopddfdgdabjanjmeodpkmlhapkkl') || (info.id=='ncdgipmkgkhennagnfmnlkflidilhbdi'))
